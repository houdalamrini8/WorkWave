    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a href="ListeOffreParEntrepC.php?id=<?= $entreprise['id_entreprise'] ?>" class="btn-offres mt-3">Voir les offres de cette entreprise</a>
            </div>
        </div>
        <a href="ListeOffreC.php" class="btn btn-secondary mt-4">← Retour à la liste</a>
    </div>
</div>

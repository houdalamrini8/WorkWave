...
<body>
    <h1>Offres publiees par cette entreprise</h1>
    <div class="grid-container">
        <?php if ($result->num_rows === 0): ?>
            <p>Aucune offre trouvee pour cette entreprise.</p>
        <?php else: ?>
            <?php while ($offre = $result->fetch_assoc()): ?>
                <div class="offre-card" style="border: 5px solid #D2B48C;">
                    <div class="text-part">
                        ...
                        <a href="ProfilOffre.php?id=<?= $offre['id_offre'] ?>">plus de détails ></a>
                    </div>
